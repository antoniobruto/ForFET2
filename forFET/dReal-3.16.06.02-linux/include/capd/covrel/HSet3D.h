...
// interval versions
  ...
  GridSet<IMatrix>& gridWall( GridSet<IMatrix>& G,
      size_type grid1, size_type grid2, size_type dir, int sign=0,
      size_type d1=0, size_type d2=1, size_type d3=2
  ) const;
  ...
  GridSet<IMatrix>& gridSet( GridSet<IMatrix> &G,
      size_type grid1, size_type grid2, size_type grid3,
      size_type d1=0, size_type d2=1, size_type d3=2
  ) const;
...
GridSet<IMatrix>& HSet3D::gridWall( GridSet<IMatrix>& G,
    size_type grid1, size_type grid2, size_type dir, int sign,
    size_type d1, size_type d2, size_type d3
) const
{
