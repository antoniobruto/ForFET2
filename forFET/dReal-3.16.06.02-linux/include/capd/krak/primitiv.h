...
// Consult  http://capd.ii.ujs.edu.pl/ for details.
...
namespace krak{
   ...
   void DrawTxtg(capd::krak::Frame *frm,const char *buf);
   void DrawTxtc(capd::krak::Frame *frm,const char *buf);
   void Rctngl_at(capd::krak::Frame *frm,int lti,int ltj,int rbi,int rbj);
   void outchar(capd::krak::Frame *frm,int row,int col,const char * ch);
