...
public:
  ...
  typedef capd::diffAlgebra::Hessian<ScalarType,VectorType::csDim,ImageVectorType::csDim> HessianType;
  ...
  */
  ...
  /**
   *  Computes jet to degree 'degree' of the map at a vector 'u' that was send to any vector or function evaluating value.
   *  In this case computation can be speeded up.
   */
  template<class JetT>
 ...
 // using BaseFunction::setParameters;
   ...
   *
   * This method generates code of new class in which DAG is built in as static array, dimensions are fixed giving the compiler chance
