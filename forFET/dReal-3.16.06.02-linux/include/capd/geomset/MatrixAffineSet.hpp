...
MatrixAffineSet<MatrixType>::MatrixAffineSet(size_type dim) :
...
{
  m_invBjac = capd::matrixAlgorithms::krawczykInverse(B);
}


template<typename MatrixType>
void MatrixAffineSet<MatrixType>::setToIdentity(){
   m_D.setToIdentity();
