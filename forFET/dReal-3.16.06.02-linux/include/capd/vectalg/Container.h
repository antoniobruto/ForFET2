...
protected:
  ...
  const static size_type defaultSize = capacity;
};
...
template<typename Scalar, __size_type capacity>
inline void* Container<Scalar,capacity>::operator new[](size_t sizeOfData,size_type)
{
  return ::operator new[](sizeOfData);
}
...
template <typename Scalar>
inline void* Container<Scalar,0>::operator new[](size_t sizeOfData,size_type newSize)
{
  defaultSize = newSize;
  return ::operator new[](sizeOfData);
}
