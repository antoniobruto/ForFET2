...
#ifndef _CAPD_DYNSYS_FADTAYLOR_HPP_
#define _CAPD_DYNSYS_FADTAYLOR_HPP_
...
FadTaylor<FadMapT,StepControlT>::FadTaylor(MapType& f, size_type _order, const StepControlT& _stepControl)
...
template<class FadMapT, typename StepControlT>
typename FadTaylor<FadMapT,StepControlT>::VectorType 
FadTaylor<FadMapT,StepControlT>::Phi(const ScalarType& t, const VectorType& v)
{
...
template<class FadMapT, typename StepControlT>
typename FadTaylor<FadMapT,StepControlT>::VectorType 
FadTaylor<FadMapT,StepControlT>::enclosure(const ScalarType& t, const VectorType& x)
{
  return capd::dynsys::enclosure(this->getVectorField(),t,x,this->getStep());
}

//###########################################################//

template<class FadMapT, typename StepControlT>
typename FadTaylor<FadMapT,StepControlT>::MatrixType 
FadTaylor<FadMapT,StepControlT>::JacPhi(const ScalarType& t, const VectorType& u)
{
...
template<typename MapType, typename StepControlType>
void FadTaylor<MapType,StepControlType>::encloseC1Map(
      const ScalarType& t,
      const VectorType& x,
      const VectorType& xx,
      VectorType& o_phi,
...
template<class FadMapT, typename StepControlT>
typename FadTaylor<FadMapT,StepControlT>::VectorType
FadTaylor<FadMapT,StepControlT>::Remainder(const ScalarType& t, const VectorType& v, VectorType& o_enc)
{
...
template<class FadMapT, typename StepControlT>
void FadTaylor<FadMapT,StepControlT>::JacRemainder(
        const ScalarType& t,
...
template<class FadMapT, typename StepControlT>
typename FadTaylor<FadMapT,StepControlT>::MatrixType 
FadTaylor<FadMapT,StepControlT>::jacEnclosure(const ScalarType& t, const VectorType& enc)
{
  return capd::dynsys::jacEnclosure(this->m_vectorField,t,this->m_step,enc,capd::vectalg::EuclLNorm<VectorType,MatrixType>());
}

//###########################################################//

template<class FadMapT, typename StepControlT>
typename FadTaylor<FadMapT,StepControlT>::ScalarType
FadTaylor<FadMapT,StepControlT>::getCoeffNorm(size_type r, size_type degree) const
{
...
#endif // _CAPD_DYNSYS_FADTAYLOR_HPP_
