...
#ifndef _CAPD_DYNSYS_BASICC2SOLVER_H_
#define _CAPD_DYNSYS_BASICC2SOLVER_H_
...
>
class BasicC2Solver : public virtual BasicSolver<MapT, StepControlT, CurveT>{
public:
  ...
  BasicC2Solver(MapType& vectorField, size_type order, const StepControlT& stepControl = StepControlT());
  ...
  void operator()(JetT& jet){
    C2JetMove<BasicC2Solver,JetT>::move(jet,*this);
  }
...
protected:
  BasicC2Solver(const BasicC2Solver& t) : BaseTaylor(t){}
  void operator=(const BasicC2Solver&){}
...
inline typename BasicC2Solver<MapType, StepControlType,CurveT>::VectorType
BasicC2Solver<MapType, StepControlType,CurveT>::operator()(ScalarType& t, const VectorType &v, MatrixType& der, HessianType& coeff)
{
...
#endif // _CAPD_DYNSYS_BASICC2SOLVER_H_
