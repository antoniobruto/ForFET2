...
#ifndef _CAPD_DYNSYS_BASICSOLVER_HPP_
#define _CAPD_DYNSYS_BASICSOLVER_HPP_
...
BasicSolver<MapType, StepControlType, CurveT>::BasicSolver(MapType& vectorField, size_type order, const StepControlType& stepControl)
...
template <typename MapType, typename StepControlType, typename CurveT>
void BasicSolver<MapType, StepControlType, CurveT>::setOrder(size_type order)
{
...
template <typename MapType, typename StepControlType, typename CurveT>
typename BasicSolver<MapType, StepControlType, CurveT>::VectorType
BasicSolver<MapType, StepControlType, CurveT>::operator()(VectorType v)
{
...
template <typename MapType, typename StepControlType, typename CurveT>
typename BasicSolver<MapType, StepControlType, CurveT>::VectorType
BasicSolver<MapType, StepControlType, CurveT>::operator()(VectorType v, MatrixType& der)
{
  VectorType* coeff = this->getCoefficientsAtCenter();
...
template <typename MapType, typename StepControlType, typename CurveT>
typename BasicSolver<MapType, StepControlType, CurveT>::VectorType
BasicSolver<MapType, StepControlType, CurveT>::operator()(VectorType v, const MatrixType& derivative, MatrixType & resultDerivative)
{
  VectorType* coeff = this->getCoefficientsAtCenter();
  MatrixType* matrixCoeff = this->getMatrixCoefficients();
  coeff[0] = v;
...
template <typename MapType, typename StepControlType,typename CurveT>
void BasicSolver<MapType,StepControlType,CurveT>::sumTaylorSeries(
      VectorType& v,
      VectorType* coeff,
      size_type order
  )
...
template <typename MapType, typename StepControlType, typename CurveT>
const typename BasicSolver<MapType, StepControlType, CurveT>::SolutionCurve&
BasicSolver<MapType, StepControlType, CurveT>::getCurve()
{
...
template <typename MapType, typename StepControlType, typename CurveT>
typename BasicSolver<MapType, StepControlType, CurveT>::ScalarType
BasicSolver<MapType, StepControlType, CurveT>::getCoeffNorm(size_type r, size_type degree) const
{
...
#endif // _CAPD_DYNSYS_BASICSOLVER_HPP_
/// @}
