...
#ifndef _CAPD_DYNSYS_CNSOLVER_REMAINDER_HPP_
#define _CAPD_DYNSYS_CNSOLVER_REMAINDER_HPP_
...
CnSolver<MapType,StepControlType,CurveType>::Remainder(const ScalarType& t, const VectorType &iv, VectorType& o_enc)
{
...
template<typename MapType, typename StepControlType,typename CurveType>
void CnSolver<MapType,StepControlType,CurveType>::JacRemainder(
      const ScalarType& t,
...
void CnSolver<MapType,StepControlT,CurveT>::c2Remainder(
...
#endif // _CAPD_DYNSYS_CNSOLVER_REMAINDER_HPP_
