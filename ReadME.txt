...
We assume that you are using the virtual machine provided by the TACAS 2021
program committee for artefact evaluation. 
...
2.	To visualize trace_n (where n is a positive number), copy trace_n.json
	...
	ForFET-SMT-TACAS21, and if your current path is 'ForFET-SMT-TACAS21/forFET/work'
...
External Tool Downloads (not-necessary since all binaries and libraries are already included)
